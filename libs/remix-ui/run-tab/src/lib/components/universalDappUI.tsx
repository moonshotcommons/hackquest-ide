          ...
          <div className="d-flex flex-row justify-content-between mt-2">
            ...
            <CustomTooltip placement={'bottom-end'} tooltipClasses="text-wrap" tooltipId="receiveEthDocstoolTip" tooltipText={<FormattedMessage id="udapp.tooltipText8" />}>
              <a href="https://solidity.readthedocs.io/en/v0.6.2/contracts.html#receive-ether-function" target="_blank" rel="noreferrer">
                ...
                <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg" className="fas fa-info my-2 mr-1">
                  <circle cx="8.5" cy="8.5" r="8.5" fill="#8C8C8C" />
                  <circle cx="8.4999" cy="4.25039" r="0.85" fill="white" />
                  <rect x="7.6499" y="5.94922" width="1.7" height="7.65" rx="0.85" fill="white" />
                </svg>
              </a>
            </CustomTooltip>
          </div>
